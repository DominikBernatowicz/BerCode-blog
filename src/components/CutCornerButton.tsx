...
export const CutCornerButton = (props: ComponentPropsWithoutRef<"button">) => {
    ...
    return (
            <button className={twMerge("bg-fuchsia-500/20 hover:scale-105 transition-all ease-linear duration-300 px-4 py-2 font-extrabold uppercase font-heading text-sm tracking-wide relative z-10", className)}>
